...
const Hero = ({pref}) => {
  return (
    <div ref={pref} className=' flex relative mt-20 lg:mt-14 gap-y-10 pb-10  lg:gap-y-0 flex-col h-[60vh] lg:h-[100vh] items-center justify-center overflow-hidden
    ...
    '>
      ...
      >
        ...
        <h1 className=' text-4xl mt-5 lg:text-5xl  lg:mt-10  text-white  font-anta'>Intra College Cultural Fest</h1>
        </div>

      

        <div className='absolute text-center top-1/2 '>
        <h1 className=' text-2xl lg:text-4xl mt-12 lg:mt-32 text-white font-anta'>March 27-28, 2024</h1> 
